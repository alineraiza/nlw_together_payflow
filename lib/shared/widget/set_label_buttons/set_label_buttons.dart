...
class SetLabelButtons extends StatelessWidget {
  ...
  const SetLabelButtons ({ Key? key, required this.primaryLabel, required this.primaryOnPressed, required this.secundaryLabel, required this.secundaryOnPressed }) : super(key: key);
